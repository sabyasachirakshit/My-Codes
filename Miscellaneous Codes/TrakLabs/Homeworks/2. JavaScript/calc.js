...
button1.addEventListener('click', function Addition_of_Numbers() {
    ...
    if (isNaN(Number(number1)) && isNaN(Number(number2))) {
        document.getElementById('res_box').innerText = "Please input a number in Box1 and Box2.";
    }
    else if (isNaN(Number(number1))) {
        document.getElementById('res_box').innerText = "Please input a number in Box1.";
    }
    else if (isNaN(Number(number2))) {
        document.getElementById('res_box').innerText = "Please input a number in Box2.";
    }
    else {
        document.getElementById('res_box').innerText = Number(number1) + Number(number2);
    }
});
